        ...
        <div class="main-content-block">
            <div class="d-flex align-items-center justify-content-between flex-wrap">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="content-header-title">@section('title', __('Edit Cms Page'))</li>
                        <li class="breadcrumb-item"><a href="{{ route('cms-pages.index') }}">{{ __('Cms Pages') }}</a></li>
                         <li class="breadcrumb-item active">{{ __('Edit Cms Page') }}</li>
                    </ol>
                </nav>
            ...
            <div class="card profile-card mb-5">
                <div class="row">
                    <div class="col-md-12">
                        <div class="row m-1">
                            @include('cms-pages::form', compact('form'))
                        </div>
                    </div>
                </div>
            </div>
